                ...
                <form action="{{ url('employee/create') }}" method="HEAD">
                    ...
                    <div class="row">
                        <div class="col-md-12 mt-3">
                            <input type="submit" class="btn btn-danger bg-info" value="Register">
                        </div>
                        ...
                        <tbody>
                            @foreach ($employ as $item)
                                ...
                                <tr>
                                    ...
                                    <td>{{$item->dob}}</td>
                                    <td>
                                        <a href="{{ url('employee/'.$item->id.'/edit') }}" class="btn btn-info bg-green">Edit</a>
                                        
                                        <a href="{{ url('employee/'.$item->id.'/edit') }}" class="btn btn-info bg-red">Delete</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
